                  ...
                  <tr key={item.id} className="hover:bg-slate-50/50">
                    ...
                    <td className="py-1.5 px-2">
                      <input
                        ...
                        className="w-full px-2 py-1 bg-white border border-slate-200 rounded text-xs text-slate-800 focus:border-blue-550 focus:outline-none"
                      />
                    </td>
                    <td className="py-1.5 px-2">
                      <input
                        ...
                        className="w-full px-1.5 py-1 bg-white border border-slate-200 rounded font-mono text-xs text-slate-800 text-right focus:border-blue-550 focus:outline-none"
                      />
                    </td>
